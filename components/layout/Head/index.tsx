...
export const DEFAULT_HEAD_VALUES: HeadProps = {
  title: "Iván Velasteguí - Software Engineer",
  description:
    "Startup founder and Software Engineer - Open to work remotely, connect with founders and work with startups",
  imgUrl: "https://ivan.unamacro.com/portrait.jpg",
} as const;

export const Head = (props: Partial<HeadProps>) => {
  const { title, description, imgUrl } = { ...DEFAULT_HEAD_VALUES, ...props };

  // TODO: substring all descriptions?
